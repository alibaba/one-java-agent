...
public abstract class ClassLoader_Instrument {
    public Class<?> loadClass(String name) throws ClassNotFoundException {
        ...
        if (name != null && name.startsWith("io.oneagent.")) {
        ...
        isPluginClassLoader = this.getClass().getName().equals("io.oneagent.plugin.classloader.PluginClassLoader");
